            ...
            >
               <div className='grid sm:grid-cols-2 gap-6'>
                  <div>
                     ...
                     <select
                        ...
                        className={`mt-2 w-full rounded-xl border px-4 py-2.5 text-gray-900 focus:outline-none focus:ring-[#ffb200] focus:border-[#ffb200] ${
               ...
               <div className='grid sm:grid-cols-2 gap-6'>
                  <div>
                     ...
                     <input
                        ...
                        className={`mt-2 w-full rounded-xl border px-4 py-2.5 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-[#ffb200] focus:border-[#ffb200] ${
               ...
               <div className='grid sm:grid-cols-2 gap-6'>
                  ...
                  <div>
                     ...
                     <select
                        ...
                        className={`mt-2 w-full rounded-xl border px-4 py-2.5 text-gray-900 disabled:bg-gray-100 disabled:text-gray-400 focus:outline-none focus:ring-[#ffb200] focus:border-[#ffb200] ${
               ...
               <div className='flex items-center gap-3'>
                  <input
                     ...
                     className='h-4 w-4 rounded border-gray-300 accent-[#ffb200]'
                  />
                  <label
                     htmlFor='agree'
                     className={`text-sm ${
               ...
               <div className='capitalize pt-2 flex items-center justify-end'>
                  ...
                  >
                     {!isLoggedIn
                        ...
                        : isSubmitting
                        ? 'Processing...'
                        : `Book Now for ₹999 + GST = ${new Intl.NumberFormat(
                             'en-IN',
                             {
                                style: 'currency',
                                currency: 'INR',
