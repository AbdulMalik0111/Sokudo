...
const ProductDetails = () => {
   ...
   useEffect(() => {
      ...
      if (Array.isArray(product.colors) && product.colors.length > 0) {
         ...
         setSelectedImage(
            (firstWithImages.images && firstWithImages.images[0]) ??
   ...
   const handleColorSelect = (col) => {
      ...
      const imgs =
         Array.isArray(col.images) && col.images.length
            ? col.images
            : product.images || [];
...
const ProductInfo = ({
   ...
   return (
      <div className='mt-8 lg:mt-0'>
         <h2 className='heading text-3xl lg:text-4xl font-semibold text-gray-900 tracking-tight'>
            {product.name}
         </h2>
            ...
            <div className='mt-4'>
               ...
               <div className='flex items-center gap-3'>
                  {colors.map((col, i) => {
                     ...
                     const isActive =
                        selectedColor && selectedColor.name === col.name;
                     return (
                        <button
                           key={i}
         ...
         <p
            className={`mt-6 text-base text-gray-600 leading-relaxed ${
               !showFullDesc ? 'truncate-mobile' : 'show-full'
            }`}
         >
            {product.description}
         </p>
         ...
         {product.description?.length > 150 && (
            <button
               className='text-[#ffb200] font-medium text-sm mt-2 block'
...
const SpecificationSection = ({
   ...
   <div className='mt-20'>
      <h2 className='heading text-3xl font-semibold text-gray-900 mb-8 text-center'>
...
const ImageModal = ({ isOpen, onClose, image }) => {
   ...
   return (
      ...
      >
         ...
         />
         <button
            className='absolute top-4 right-4 text-white text-3xl hover:opacity-80 transition'
            onClick={onClose}
         >
            <FiX size={32} />
         </button>
